...
const MODELS: Record<string, number> = {'Unity XT 380': 500, 'Unity XT 480': 750, 'Unity XT 680': 1000, 'Unity XT 880': 1500};
...
const TIERS: Array<[string, string[]]> = [('Extreme Performance', ['400GB', '800GB', '1.6TB', '1.92TB', '3.2TB', '3.84TB', '7.68TB', '15.36TB']), ('Performance', ['1.2TB', '1.8TB']), ('Capacity', ['4TB', '6TB', '12TB'])] as any;
...
export default function Page() {
  ...
  const setRow = (tier: string, patch: Partial<Row>) => setRows(prev => ({ ...prev, [tier]: { ...prev[tier], ...patch } }));
  ...
  const suggestions: Record<string, number[]> = useMemo(() => {
    ...
    for (const [tier] of TIERS) {
      ...
      out[tier] = [0, ...opts];
      // اگر انتخاب فعلی در لیست نیست، درجش کن تا از بین نره
  ...
  return (<main style={maxWidth:1100, margin:'0 auto', padding:24, fontFamily:'system-ui, -apple-system, Segoe UI, Roboto'}>
